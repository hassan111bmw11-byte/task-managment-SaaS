  ...
  return (
    <div className="h-80 bg-white w-screen">
      ...
      <div className="mt-8 flex justify-center gap-4">
        <div className="w-60  transition-all duration-500 ease hover:bg-zinc-400 h-30 flex flex-col justify-center items-center bg-zinc-300">
          <h1 className="font-bold text-blue-800 text-4xl">10K+</h1>
          <p className="mt-2">Hapyy users</p>
        </div>
        <div className="w-60 h-30 transition-all duration-500 ease hover:bg-zinc-400 flex flex-col justify-center items-center bg-zinc-300">
