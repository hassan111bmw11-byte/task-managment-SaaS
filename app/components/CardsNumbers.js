export default function NumberCards({ status, numbers = 0, icon }) {
  return (
    <div className="ml-8 w-60 h-24 text-black py-4 hover:bg-zinc-400 transition-all duration-500 ease rounded-2xl flex justify-between items-center bg-white mt-8 shadow-2xl border border-zinc-500">
      <div>
